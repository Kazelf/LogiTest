...
services:
  ...
  shoplite        Express e-commerce backend, run separately
...
> ShopLite dùng Node.js/Express để sinh log nghiệp vụ. LogiTest AI dùng FastAPI vì phần lõi là xử lý dữ liệu, phân tích journey, sinh test và báo cáo. Hai phần tách vai trò rõ ràng nên vừa đơn giản để demo, vừa hợp lý về kỹ thuật.
